...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        >
            ...
            <div
                v-if="dates.length > 0 && subscribers.length > 0"
            ...
            >
                <p class="text-center text-sm text-muted-foreground">
                    Set the hackathon start and end dates to track attendance by
                    day.
                </p>
            ...
            >
                <p class="text-center text-sm text-muted-foreground">
                    No subscribers yet. Add subscribers first to track
                    attendance.
                </p>
                <Button variant="outline" as-child class="mt-4">
                    <Link
