...
function submit(): void {
    ...
    router.put(
        WorkExperienceController.update.url(props.workExperience.id),
        payload,
        {
            preserveScroll: true,
            onFinish: () => {
                    ...
                    <CardContent class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        <form class="contents" @submit.prevent="submit">
                            <div class="space-y-4">
                                ...
                                >
                                    <Label for="parent_id_select">
                                        Promotion from (previous position at
                                        same company)
                                    </Label>
                                    <SearchableSelect
                                        id="parent_id_select"
                            ...
                            <div class="space-y-2 lg:col-span-2">
                                ...
                                <InputError
                                    :message="formErrors.show_company"
                                />
                            </div>
