                        ...
                        <CardContent class="space-y-6">
                            <div class="grid gap-2">
                                ...
                                <p class="text-xs text-muted-foreground">
                                    Use lowercase, no spaces (e.g. admin,
                                    content-editor)
                                </p>
                            ...
                            <div class="space-y-4">
                                ...
                                <p class="text-xs text-muted-foreground">
                                    Assign policy-based permissions to this
                                    role. Users with this role will be able to
                                    perform the selected actions.
                                </p>
                                <template
                                    v-for="id in selectedPermissionIds"
                                    :key="`hidden-${id}`"
                                >
                                    <input
                                        type="hidden"
                                ...
                                >
                                    No policy permissions found. Add
                                    can('Ability:Resource') in app/Policies to
                                    discover them.
                                </p>
