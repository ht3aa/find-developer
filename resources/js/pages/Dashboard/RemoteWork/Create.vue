...
const { jobTitles, currencies, locations } = defineProps<{
    jobTitles: Opt[];
    currencies: EnumOpt[];
    locations: EnumOpt[];
}>();
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: remoteWorkDashboard.create.url() },
];
...
function submit(): void {
    form
        ...
        .post(remoteWorkDashboard.store.url(), {
            preserveScroll: true,
        });
}
</script>
