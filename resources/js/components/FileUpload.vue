    ...
    <div class="grid gap-2">
        ...
        >
            ...
            <template v-if="modelValue">
                <div
                    class="relative z-10 flex items-center gap-3 rounded-md bg-background/80 px-4 py-2.5 shadow-sm ring-1 ring-border/50"
                >
                    ...
                    <button
                        type="button"
                        class="shrink-0 rounded-full p-1 text-muted-foreground transition-colors hover:bg-destructive/10 hover:text-destructive focus:ring-2 focus:ring-ring focus:outline-none"
