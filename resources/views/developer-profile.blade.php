                    ...
                    <div class="dev-profile-projects-grid">
                        @foreach($developer->projects as $project)
                            <div class="dev-profile-project-card">
                                ...
                                @endif
                                @if($project->link)
                                    <a href="{{ $project->link }}" target="_blank" rel="noopener noreferrer" class="dev-profile-project-link">
                                        View Project
                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="16" height="16">
            ...
            <div class="dev-profile-sidebar">
                ...
                <div class="dev-profile-sidebar-card">
                    ...
                    <div class="dev-profile-contact-links">
                        ...
                        <a href="{{ $developer->portfolio_url }}" target="_blank" rel="noopener noreferrer" class="dev-profile-contact-btn dev-profile-contact-portfolio">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="18" height="18">
                        ...
                        <a href="{{ $developer->github_url }}" target="_blank" rel="noopener noreferrer" class="dev-profile-contact-btn dev-profile-contact-github">
                        ...
                        <a href="{{ $developer->linkedin_url }}" target="_blank" rel="noopener noreferrer" class="dev-profile-contact-btn dev-profile-contact-linkedin">
                            <svg fill="currentColor" viewBox="0 0 24 24" width="18" height="18">
