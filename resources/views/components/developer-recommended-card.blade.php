...
<div class="developer-card developer-card-recommended">
    ...
    <!-- Badges -->
    <x-developer-badges-icons :developer="$developer" />
                ...
                @auth
                    ...
                    @elseif(!auth()->user()->isAdmin() && !auth()->user()->isSuperAdmin() && ($developer->expected_salary_from || $developer->expected_salary_to))
                        <div class="detail-item">
                            ...
                            <a href="mailto:ht3aa2001@gmail.com?subject=Subscription%20Inquiry" target="_blank" style="text-decoration: none; color: inherit;">
