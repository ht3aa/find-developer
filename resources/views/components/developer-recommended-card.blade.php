...
<div class="developer-card developer-card-recommended">
    <div class="recommended-badge-card">
        <svg class="recommended-icon-card" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="recommended-card-grid">
        ...
        <div class="recommended-column recommended-column-work">
        ...
        <div class="recommended-column recommended-column-content">
            <!-- Header -->
