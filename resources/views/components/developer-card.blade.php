...
<div class="developer-card {{ $isPremium ? 'developer-card-premium' : ($isPro ? 'developer-card-pro' : '') }}">
    @if($isPremium)
    ...
    <div class="developer-details">
        ...
        @if($developer->expected_salary_from || $developer->expected_salary_to)
            <div class="detail-item">
                ...
                @if($developer->expected_salary_from && $developer->expected_salary_to)
                    {{ number_format($developer->expected_salary_from) }} - {{ number_format($developer->expected_salary_to) }} IQD/month
                @elseif($developer->expected_salary_from)
                    From {{ number_format($developer->expected_salary_from) }} IQD/year
                @else
                    Up to {{ number_format($developer->expected_salary_to) }} IQD/year
                @endif
            </div>
        @endif
