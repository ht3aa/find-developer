...
<div class="developer-card developer-card-premium">
    <div class="developer-card-badges-row">
        <div class="premium-badge">
            <svg class="premium-icon" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            </svg>
            Premium
        </div>
        @if($showRecommendedBadge)
            <div class="developer-card-recommended-pill">
                ...
                <div class="work-items">
                    @foreach($developer->projects as $index => $project)
                        <div class="work-item">
                            ...
                            @endif
                            @if($project->link)
                                <a href="{{ $project->link }}" target="_blank" rel="noopener noreferrer" class="work-item-link">
                                    View Project
                    ...
                    @elseif($developer->projects_count > 6)
        ...
        <div class="premium-column premium-column-content">
            ...
            <div class="developer-links">
                @if($developer->portfolio_url)
                    <a href="{{ $developer->portfolio_url }}" target="_blank" rel="noopener noreferrer" class="social-link" title="Portfolio">
                ...
                @if($developer->github_url)
                    <a href="{{ $developer->github_url }}" target="_blank" rel="noopener noreferrer" class="social-link github" title="GitHub">
                ...
                @if($developer->linkedin_url)
                    <a href="{{ $developer->linkedin_url }}" target="_blank" rel="noopener noreferrer" class="social-link linkedin" title="LinkedIn">
                        <svg class="social-icon" fill="currentColor" viewBox="0 0 24 24">
