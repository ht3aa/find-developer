<div class="modern-container">
    ...
    <div class="modern-header">
        <div class="header-content">
            <h1 class="modern-title">Find Special Needs Developers</h1>
            <p class="modern-subtitle">Discover talented special needs developers ready to bring your projects to life</p>
        </div>
    </div>
