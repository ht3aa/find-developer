<div class="recommended-container">
    ...
    <div class="results-header">
        <div class="results-count-modern">
            ...
            <span class="results-label">recommended developer{{ $totalCount !== 1 ? 's' : '' }}</span>
        </div>
    ...
    <div wire:loading class="modern-loading">
        ...
        <span class="loading-text">Searching recommended developers...</span>
    </div>

    <!-- Premium Recommended Developers -->
        ...
        <div id="free-developers-section" class="modern-section">
            <div class="section-header-modern">
                <div class="section-title-wrapper">
                    ...
                    <div>
                        <h2 class="section-title-modern">All Recommended Developers</h2>
                        <p class="section-subtitle-modern">Browse all recommended developers</p>
                    </div>
                </div>
            </div>
            <div class="developers-grid-modern">
    ...
    @if($totalCount == 0)
        <div class="empty-state-modern">
            ...
            <h3 class="empty-title-modern">No recommended developers found</h3>
