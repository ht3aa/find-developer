        ...
        <nav class="navbar" x-data="{ mobileMenuOpen: false }">
            <div class="navbar-container">
                ...
                <div class="navbar-menu" x-show="mobileMenuOpen" @click.away="mobileMenuOpen = false">
                    ...
                    <a href="{{ route('companies') }}" class="navbar-link {{ request()->routeIs('companies') ? 'navbar-link-active' : '' }}" @click="mobileMenuOpen = false">
                        Companies
                    </a>
        ...
        <footer class="footer">
            ...
            <div class="footer-container">
                <div class="footer-links">
                    ...
                    <a href="{{ route('companies') }}" class="footer-link">
                        Companies
                    </a>
