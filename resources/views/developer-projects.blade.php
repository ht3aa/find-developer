                ...
                <div class="developer-info-card">
                    ...
                    <div class="developer-contact-info">
                        ...
                        @if($developer->portfolio_url)
                            <a href="{{ $developer->portfolio_url }}" target="_blank" rel="noopener noreferrer" class="contact-button portfolio-button">
                                <svg class="contact-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @if($developer->github_url)
                            <a href="{{ $developer->github_url }}" target="_blank" rel="noopener noreferrer" class="contact-button github-button">
                        ...
                        @if($developer->linkedin_url)
                            <a href="{{ $developer->linkedin_url }}" target="_blank" rel="noopener noreferrer" class="contact-button linkedin-button">
                                <svg class="contact-icon" fill="currentColor" viewBox="0 0 24 24">
