...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; padding: 8px 16px; background-color: hsl(38, 92%, 50%); color: hsl(220, 15%, 10%); text-decoration: none; border-radius: 5px; margin-top: 8px; font-size: 0.9em; font-weight: 500; }
