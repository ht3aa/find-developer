...
class DeveloperResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $canViewCv = $isOwner || ($user && $user->can('viewCv', Developer::class));
        ...
        return [
            ...
            'expected_salary_to' => $canViewCv ? number_format($developer->expected_salary_to) : null,
            'currency' => $canViewCv ? $developer->currency : null,
            ...
            'cv_path_url' => $canViewCv ? $developer->cv_path_url : null,
            ...
            'location' => $location !== null
                ? ['value' => $location->value, 'label' => $location->getLabel()]
                : null,
