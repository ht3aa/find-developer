...
class RecommendedDevelopers extends Component implements HasActions, HasSchemas
{
        ...
        return $schema
            ->components([
                Section::make('Filters')
                    ->collapsible()
                    ->description('Filter recommended developers by various criteria')
                    ->schema([
    ...
    public function render()
    {
        ...
        return view('livewire.recommended-developers', $this->getViewData($filters));
    }
}
